...
if (isset($routesArray[3])) {
    ...
    if ($security[1] == $_SESSION["user"]->token_user) {
        $select = "*";
        $url = "relations?rel=elements,classes,powers,materials,technologies,rouds&type=element,class,power,material,technology,roud&select=" . $select . "&linkTo=id_element&equalTo=" . $security[0];
        $method = "GET";
        $fields = array();
