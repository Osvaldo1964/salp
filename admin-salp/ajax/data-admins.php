...
class DatatableController{
	...
	public function data(){
		...
		if(!empty($_POST)){
            ...
            $url = "users?select=id_user&linkTo=date_created_user&between1=".$_GET["between1"]."&between2=".$_GET["between2"]."&filterTo=id_rol_user&inTo='Administradores'";
			$method = "GET";
			$fields = array();
            ...
            $select = "id_user,picture_user,fullname_user,username_user,email_user,address_user,date_created_user,method_user";
            ...
            if(!empty($_POST['search']['value'])){
            	if(preg_match('/^[0-9A-Za-zñÑáéíóú ]{1,}$/',$_POST['search']['value'])){
	            	...
	            	foreach ($linkTo as $key => $value) {
	            		$url = "users?select=".$select."&linkTo=".$value.",id_rol_user&search=".$search.",Administradores&orderBy=".$orderBy."&orderMode=".$orderType."&startAt=".$start."&endAt=".$length;
	            ...
	            $url = "users?select=".$select."&linkTo=date_created_user&between1=".$_GET["between1"]."&between2=".$_GET["between2"]."&filterTo=id_rol_user&inTo='Administradores'&orderBy=".$orderBy."&orderMode=".$orderType."&startAt=".$start."&endAt=".$length;
