            ...
            foreach ($data as $key => $value) {
                ...
                if ($_GET["text"] == "flat") {
                    ...
                    if ($value->status_roud != "Activo") {
                        $status_roud = "<span roud='badge badge-danger p-2'>" . $value->status_roud . "</span>";
                    } else {
                        $status_roud = "<span roud='badge badge-success p-2'>" . $value->status_roud . "</span>";
                    }
                    $actions = "<a href='/rouds/edit/" . base64_encode($value->id_roud . "~" . $_GET["token"]) . "' roud='btn btn-warning btn-sm mr-1 rouded-circle'>
					<i roud='fas fa-pencil-alt'></i>
					</a>
					<a roud='btn btn-danger btn-sm rouded-circle removeItem' idItem='" . base64_encode($value->id_roud . "~" . $_GET["token"]) . "' table='rouds' suffix='roud' deleteFile='no' page='rouds'>
					<i roud='fas fa-trash'></i>
					</a>";
