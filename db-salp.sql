...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-11-2024 a las 03:08:52
...
--
-- Estructura de tabla para la tabla `energies`
--

CREATE TABLE `energies` (
  `id_energy` bigint(20) NOT NULL,
  `id_lender_energy` bigint(20) NOT NULL,
  `period_energy` int(6) NOT NULL,
  `bill_energy` varchar(15) NOT NULL,
  `amount_energy` decimal(15,2) NOT NULL,
  `fee_energy` decimal(15,2) NOT NULL,
  `total_energy` decimal(15,2) NOT NULL,
  `status_energy` varchar(6) NOT NULL DEFAULT 'Activo',
  `date_created_energy` date DEFAULT NULL,
  `date_updated_energy` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `energies`
--

INSERT INTO `energies` (`id_energy`, `id_lender_energy`, `period_energy`, `bill_energy`, `amount_energy`, `fee_energy`, `total_energy`, `status_energy`, `date_created_energy`, `date_updated_energy`) VALUES
(1, 1, 202401, '31112102001953', 16116.00, 496.90, 8008040.40, 'Activo', '2024-11-09', '2024-11-09 21:05:40'),
(2, 1, 202403, '15252', 11625.00, 496.25, 0.00, 'Activo', '2024-11-10', '2024-11-10 22:20:22'),
(3, 1, 202402, '1425253', 116256.00, 496.25, 57.00, 'Activo', '2024-11-10', '2024-11-10 22:24:47'),
(4, 1, 202405, '7788557', 11475.00, 497.35, 5707091.25, 'Activo', '2024-11-10', '2024-11-10 22:27:24');
...
CREATE TABLE `lenders` (
  `id_lender` bigint(20) NOT NULL,
  `code_lender` varchar(10) NOT NULL,
  `name_lender` text NOT NULL,
  `date_created_lender` date DEFAULT NULL,
  `date_updated_lender` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `lenders` (`id_lender`, `code_lender`, `name_lender`, `date_created_lender`, `date_updated_lender`) VALUES
(1, '001', 'AIR-E', '2024-11-09', '2024-11-09 21:01:57');
...
(89, 1, 'led-14512', 1, 2, 1, 1, 1, 'OTRA DIRECC', 10.2652, -14.2522, 250251.00, '<p>sdgfsadasdg</p>', '[\"led-14512-5530482.jpg\"]', 'Activo', '2024-11-04', '2024-11-04 20:42:19');
...
(15, 1, 'ttr0-aslkaslsa', 50, 'KLA DDKD', 10, 24, 'Exclusivo', 'Local', 'dsdfs', 50.00, '<p>sdsd</p>', 'Activo', '[\"ttr0-aslkaslsa-15299318.jpg\"]', '2024-11-04', '2024-11-04 16:38:31'),
(16, 1, 'TRASN-001', 50, 'LA CALLE', 10, 24, 'Exclusivo', 'Local', 'C-5556D', 50.00, '<p>SDSDSDS</p>', 'Activo', '[\"trasn-001-19267023.jpg\"]', '2024-11-04', '2024-11-04 20:53:09');
...
(1, 'Osvaldo José Villalobos Cortina', 'osvicor', 'osvicor@hotmail.com', '$2a$07$azybxcags23425sdg23sdeanQZqjaf6Birm2NvcYTNtJw24CsO5uq', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE3MzEyNTQ0MTYsImV4cCI6MTczMTM0MDgxNiwiZGF0YSI6eyJpZCI6MSwiZW1haWwiOiJvc3ZpY29yQGhvdG1haWwuY29tIn19.Y370ijidjHeig5IMIl62oK2ReuqtcXJnHqxBaxBVLOU', '1731340816', 'Administradores', '1.jpg', 'Afghanistan', 'Santa Marta', 'Urb. San Lorenzo Mz J Cs 34', '93_3153153153', 'direct', '2024-06-17', '2024-06-17 18:47:27', 1, 0),
...
INSERT INTO `viewinvs` (`id_viewinv`, `id_delivery_viewinv`, `group_viewinv`, `code_viewinv`, `info_viewinv`, `address_viewinv`, `qty_viewinv`, `cost_viewinv`, `date_created_viewinv`, `date_updated_viewinv`) VALUES
(82, 1, 'LUMINARIAS', 'led-14512', 'LED 40W', 'OTRA DIRECC', 1.00, 250251.00, '2024-11-04', '2024-11-04 20:42:19'),
(83, 1, 'TRANSFORMADORES', 'TRASN-001', '50 KWh', 'LA CALLE', 1.00, 50.00, '2024-11-04', '2024-11-04 20:53:09');
...
--
-- AUTO_INCREMENT de la tabla `energies`
--
ALTER TABLE `energies`
  MODIFY `id_energy` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `lenders`
  MODIFY `id_lender` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `luminaries`
--
ALTER TABLE `luminaries`
  MODIFY `id_luminary` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
...
--
ALTER TABLE `transformers`
  MODIFY `id_transformer` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `viewinvs`
  MODIFY `id_viewinv` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;
COMMIT;
